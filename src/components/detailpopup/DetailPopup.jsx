              ...
              <div className="popup__box-text">
                <div class="popup__box-label">
                  {part.brand +
                    ...
                    part.model +
                    " " +
                    part.year.reduce((prev, curr) => prev + ", " + curr)}
                  <br />
                  {part.type}
                  {part.isBestSeller && (
                    <div className="popup__box-bestseller">
                ...
                <div class="popup__box-price">
                  {part.discount && (
                    <div className="popup__box-price-discount">
                      {part.discountedPrice} CAD
                    </div>
                  )}
                  <div
                    className={
                      "popup__box-price-real" + (part.discount ? " sale" : "")
                    }
                  >
                    {part.price} CAD
                  </div>
                ...
                <div class="popup__box-basket">
                  ...
                  <button
                    className="popup__box-basket-add"
                    onClick={() => addToCart()}
                  >
